...
public class Solution {
    ...
    // Method 2: Use double index, scan nums1 and nums2, save to a temp array.
    // public void Merge(int[] nums1, int m, int[] nums2, int n) {
    ...
    // Method 3: Similar to method 2 but this time use nums1 spare space in stead of temp array
    public void Merge(int[] nums1, int m, int[] nums2, int n) {
